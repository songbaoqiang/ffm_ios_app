...
- (void)_setup
{
    if (INTERFACE_IS_PAD)
    {
        self.boardNewsView.backgroundColor = [UIColor colorWithRed:0.961 green:0.925 blue:0.698 alpha:1.00];
        [self.boardBackgroundImageview removeFromSuperview];
    }
    else
    {
        self.boardNewsView.backgroundColor = [UIColor clearColor];
    }
