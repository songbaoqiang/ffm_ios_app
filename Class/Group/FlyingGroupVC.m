...
@property (strong, nonatomic) FlyingGroupBoard  *groupBoard;


@property (strong, nonatomic) UITableView       *groupStreamTableView;

@property (strong, nonatomic) FlyingGroupMembersCell * membersCell;
...
@property (strong, nonatomic) YALSunnyRefreshControl *sunnyRefreshControl;
...
-(void) viewDidAppear:(BOOL)animated
{
    ...
    // Show coach marks
    BOOL coachMarksShown = [[NSUserDefaults standardUserDefaults] boolForKey:@"FlyingGroupVCMarksShown"];

    if (coachMarksShown == NO)
    {

        // Don't show again
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"FlyingGroupVCMarksShown"];
        [[NSUserDefaults standardUserDefaults] synchronize];
        
        // Setup coach marks
        NSArray *coachMarks = @[
                                @{
                                    @"rect": [NSValue valueWithCGRect:self.groupBoard.frame],
                                    @"caption": @"上面是群公告区",
                                    @"shape": @"square"
                                    },
                                @{
                                    @"rect": [NSValue valueWithCGRect:self.membersCell.frame],
                                    @"caption": @"这些是最新活跃群成员",
                                    @"shape": @"square"
                                    },
                                @{
                                    @"rect": [NSValue valueWithCGRect:self.memberStartView.frame],
                                    @"caption": @"正式会员权利:查看精华推荐和聊天",
                                    @"shape": @"square"
                                    }
                                ];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        //会员Cell
        UITableViewCell * membersCell = [tableView dequeueReusableCellWithIdentifier:@"FlyingGroupMembersCell"];
