...
static NSString* const kShareStr    = @"ln_share_url";
...
- (id)initWithData:(NSData *)data
{
	if ((self = [super init]))
	{
        ...
        self.elementsToParse = [NSArray arrayWithObjects:kTitleStr, kDescripStr,kImageURLStr,
                                kContentURL,kSubURLStr, kShareStr,kProURLStr,kDurationStr,
 ...
 qualifiedName:(NSString*)qName
{
	if (self.workingEntry != nil){
		...
		if (self.storingCharacterData){
            ...
            else if ([elementName isEqualToString:kShareStr])
				self.workingEntry.shareURL  = trimmedString;
