...
-(NSUInteger)idxOfSubItemWithSubTime:(NSTimeInterval)theTimeInSeconds;//得到字幕index
-(NSUInteger)idxAfterCurrentSubTime:(NSTimeInterval)theTimeInSeconds;//空白区取得下一个字幕的index
