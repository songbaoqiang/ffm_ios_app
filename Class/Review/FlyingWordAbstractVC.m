...
- (void) viewDidAppear:(BOOL)animated
{
    ...
    // Show coach marks
    BOOL coachMarksShown = [[NSUserDefaults standardUserDefaults] boolForKey:@"FlyingWordAbstractVCMarksShown"];
    
    if (coachMarksShown == NO)
    {
        // Don't show again
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"FlyingWordAbstractVCMarksShown"];
        [[NSUserDefaults standardUserDefaults] synchronize];
        
        // Setup coach marks
        NSArray *coachMarks = @[
                                @{
                                    @"rect": [NSValue valueWithCGRect:_sentenceLabel.frame],
                                    @"caption": @"技巧:这个是您第一次碰到这个生词时的句子。",
                                    @"shape": @"square"
                                    },
                                @{
                                    @"rect": [NSValue valueWithCGRect:_coverImageView.frame],
                                    @"caption": @"技巧:点击这里可以重现生词所在视频！",
                                    @"shape": @"square"
                                    },
                                @{
                                    @"rect": [NSValue valueWithCGRect:_starRatingView.frame],
                                    @"caption": @"技巧:需要学习的重要程度，你可以自己更改！",
                                    @"shape": @"square"
                                    },
                                ];
