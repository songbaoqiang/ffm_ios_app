              ...
              failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:[FlyingDataManager getAppData].appID])
    {
              ...
              failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:groupID])
    {
             ...
             failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:boundQR])
    {
                             ...
                             failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:startDateString])
    {
        [params setObject:startDateString forKey:@"start_time"];
    }
    
    if (![NSString isBlankString:endDateString])
    {
                             ...
                             failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:cardNo])
    {
...

{
    ...
    if (![NSString isBlankString:leesonID])
    {
                           ...
                           failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:orgnizedStr])
    {
                                ...
                                failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:contentType] && ![contentType isEqualToString:@"0"])
    {
                             ...
                             failure:(void (^)(NSError* err))failure
{
    ...
    if (![NSString isBlankString:latitude])
    {
        [params setObject:latitude forKey:@"latitude"];
    }
    
    if (![NSString isBlankString:longitude])
    {
